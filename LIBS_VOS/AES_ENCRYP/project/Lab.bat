...
rem Set our paths
SET VOS2_TOOLCHAIN=\vde\toolchains\windows\vos2\gcc-linaro-arm-linux-gnueabihf-4.7-2013.03\bin
SET VOS2_SDK=\FusionSDK\vos2-sdk-winx86-release-release-30410400\vos2
SET VFI_ADK=\vde\plugins\adk-full-4.2.0-138\vos2
