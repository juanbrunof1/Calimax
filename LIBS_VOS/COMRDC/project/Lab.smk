...
#  Compile modules
#
$(ObjDir)\ComRdc.o : $(SrcDir)\ComRdc.cpp 
	@echo Compiling ComRdc.cpp
	@$(VOSTOOLCHAIN)\$(compiler) -fPIC -c $(SDKIncludes) $(ADKIncludes) $(APPIncludes) -o $(ObjDir)\ComRdc.o  $(SrcDir)\ComRdc.cpp
