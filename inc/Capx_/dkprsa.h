...
extern int pad(char *pdest_buf, char *psrc_buf, char pad_char, int pad_size, int align);
...
long lnGetEnvVar(char pchVar[], char pchFil[]);		// AJM 04/01/2011 1
...
int inAsmQs(char pchQs[], VS_BOOL fDukAsk);
...
int inCrpExcCrd(char pchAct[], int inAct);
